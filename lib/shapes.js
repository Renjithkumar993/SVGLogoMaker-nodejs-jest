...
class Triangle extends Circle {
    ...
    render(){
        const triangle =
    `<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg">
    <polygon points ="150,50 50,150 250,150" style = "fill:${this.shapeColor};stroke:${this.borderColor};stroke-width:${this.bordersize}"  />
    <text x="150" y="130" font-size="60"  font-family="${this.fontfamily}" text-anchor="middle" fill="${this.color}">${this.text}</text>
    </svg>`
return triangle;
    }
}
